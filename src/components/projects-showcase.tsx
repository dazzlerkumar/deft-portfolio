            ...
            {project.technologies.slice(0, 4).map((tech, techIndex) => (
              ...
              >
                <span 
                  ...
                  style={{
                    background: `rgba(${tech.color ? hexToRgb(tech.color) : '255, 255, 255'}, 0.1)`,
                    border: `1px solid rgba(${tech.color ? hexToRgb(tech.color) : '255, 255, 255'}, 0.2)`,
  ...
  return (
    <section className="relative py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-emerald-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
        ...
        >
          ...
          >
            ...
            <p className="text-zinc-300 text-lg max-w-2xl mx-auto leading-relaxed">
              Showcase of technical projects demonstrating modern web development skills, 
              creative problem-solving, and expertise in cutting-edge technologies.
            </p>
          </GlassCard>
        </motion.div>
