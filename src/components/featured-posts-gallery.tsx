    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
                        ...
                        sharing knowledge through practical examples and best
                        practices.
                    </p>
                </motion.div>
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div
                    className="glass-float-element w-24 h-24 absolute bottom-32 right-16 animate-float opacity-15"
                    style={{ animationDelay: "2s" }}
                />
                <div
                    className="glass-float-element w-20 h-20 absolute top-1/2 right-1/4 animate-float opacity-10"
